...
Кожна головоломка передбачає кілька загальних понять: конвеєр (conveyor) - на нього приходять нові символи чи числа, килим (carpet) - це змінні, руки працівника (hands) - фактично регістр памяті.
 ...
 На JS були переведені 5 завдань. Не обовязково брати всі завдання підряд.
...
Додатково частина завдань зібрана разом на [окремій сторінці](index.html), де код запускається по кнопці.

Для запуску програм онлайн, можна використовувати https://stackblitz.com/

[Робота з StackBlitz](https://docs.google.com/document/d/12e6vxlIrAkM_bIZUg-ayU5KA2EUuUagk3XlRU36FA1U/edit?usp=sharing)
